    ...
    Tables: {
        ...
        Relationships: [
          {
            ...
            isOneToOne: false
            referencedRelation: "package_subscriptions"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      package_subscriptions: {
        Row: {
          ...
          family_members_added: number | null
          family_members_allowed: number | null
          id: string
          monthly_fee: number
          package_type: string
          rides_included: number
          rides_used: number | null
          security_included: boolean | null
          start_date: string
          status: string | null
          updated_at: string | null
          user_id: string | null
      ...
      profiles: {
        Row: {
          ...
          gender: string | null
          how_did_you_know_about_us: string | null
          id: string
          industry: string | null
      ...
      security_personnel: {
        ...
        Relationships: [
          {
            foreignKeyName: "security_personnel_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      service_requests: {
        Row: {
          ...
          assigned_security_id: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "service_requests_assigned_security_id_fkey"
            columns: ["assigned_security_id"]
            isOneToOne: false
            referencedRelation: "security_personnel"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "service_requests_assigned_vehicle_id_fkey"
      ...
      storage_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "storage_files_bucket_id_fkey"
            columns: ["bucket_id"]
            isOneToOne: false
...
// Convenience types for mobile apps
export type PackageSubscription = Database['public']['Tables']['package_subscriptions']['Row'];
