        ...
        <div className="grid md:grid-cols-6 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-4">
              Kenya's premier luxury transportation platform, delivering exceptional mobility solutions with unmatched service excellence.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><button onClick={() => handleNavigation('/vip-membership')} className="text-gray-400 hover:text-yellow-400 transition">VIP Membership</button></li>
            </ul>
          </div>
          
          {/* Partners */}
          <div>
            <h4 className="text-sm font-semibold mb-4 text-white uppercase tracking-wider">Partners</h4>
            <ul className="space-y-2 text-sm">
          ...
          {/* Markets */}
          <div>
            <h4 className="text-sm font-semibold mb-4 text-white uppercase tracking-wider">Markets</h4>
            <ul className="space-y-2 text-sm">
              <li><span className="text-gray-400">Nairobi</span></li>
              <li><span className="text-gray-400">Mombasa</span></li>
              <li><span className="text-gray-400">Kisumu</span></li>
              <li><span className="text-gray-400">Eldoret</span></li>
              <li><span className="text-gray-400">Nakuru</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><button onClick={() => handleNavigation('/application-status')} className="text-gray-400 hover:text-yellow-400 transition">Check Application Status</button></li>
              <li><a href="tel:+254700123456" className="text-gray-400 hover:text-yellow-400 transition">+254 700 123 456</a></li>
              <li><a href="mailto:info@luxeride.org" className="text-gray-400 hover:text-yellow-400 transition">info@luxeride.org</a></li>
            </ul>
          </div>
        </div>
